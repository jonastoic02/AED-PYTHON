class Lista:
    ...
    #Pode ser usado para implementar: Pop, Remove
    ...
    #Pode ser usado para implementar : Insert, Append
...
lista = Lista()
lista.inserir(0, "jonas")
print(lista[0])
lista.inserir(len(lista), "lucas")
print(lista)
lista.inserir(0, "inacio")
print(lista)
del lista[0]
print(lista)
del lista[0]
